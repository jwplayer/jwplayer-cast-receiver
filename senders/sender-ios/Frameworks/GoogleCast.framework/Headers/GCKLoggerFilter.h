 ...
 *
 * @param minimumLevel The minimum logging level for these classes. May be GCKBLoggerLevelVerbose.
 ...
 *
 * @param minimumLevel The minimum logging level for these functions. May be GCKBLoggerLevelVerbose
 * to include all levels.

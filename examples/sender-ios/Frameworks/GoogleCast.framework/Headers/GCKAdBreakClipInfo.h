...
/** The clip's title. */
@property(nonatomic, copy, readonly, GCK_NULLABLE) NSString *title;

/** The click-through URL for this clip. */
@property(nonatomic, copy, readonly, GCK_NULLABLE) NSURL *clickThroughURL;

/** URL for the content that represents this clip (typically an image). */
@property(nonatomic, copy, readonly, GCK_NULLABLE) NSURL *contentURL;

/** MIME type of the content referenced by @ref contentURL. */
@property(nonatomic, copy, readonly, GCK_NULLABLE) NSString *mimeType;
